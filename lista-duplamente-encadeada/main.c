...
int main(){
    ...
    int op, pos;
    int mat, result, resConsultPos, contMaiores, num;
    ...
    do{
        ...
        printf("11 -> Pegar ultimo elemento da lista\n");
        printf("12 -> Contar numeros maiores que a matricula inserida\n");
        printf("13 -> Libera lista\n");
